...
class PalabrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create palabra" do
    assert_difference('Palabra.count') do
      post palabras_url, params: { palabra: { clase: @palabra.clase, partida_id: @palabra.partida_id, word: @palabra.word } }
    end
  ...
  test "should update palabra" do
    patch palabra_url(@palabra), params: { palabra: { clase: @palabra.clase, partida_id: @palabra.partida_id, word: @palabra.word } }
